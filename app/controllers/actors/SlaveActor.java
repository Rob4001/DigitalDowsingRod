...
public class SlaveActor extends UntypedActor{
	...
	public void onReceive(Object msg) throws Exception {
		if(msg instanceof Start){
			...
			this.getSender().tell(new Update(10,"Quizzing Al Gore..."), this.getSelf());
			Thread.sleep(500);
			MultiMemberWards wardData = MultiMemberWards.getMultiMemberWardsFromDatazone(postcodeObj.datazone);
			this.getSender().tell(new Update(20,"Spinning Windmills..."), this.getSelf());
			Thread.sleep(250);
			...
			this.getSender().tell(new Update(30,"Consuming Electricity..."), this.getSelf());
			Thread.sleep(250);
			...
			this.getSender().tell(new Update(40,"Arbitrating Arbitrary Numbers..."), this.getSelf());
			Thread.sleep(250);
			...
			this.getSender().tell(new Update(50,"Reticulating splines..."), this.getSelf());
			Thread.sleep(1000);
			...
			this.getSender().tell(new Update(60,"Exploring Suns Surface..."), this.getSelf());
			Thread.sleep(500);
			...
			this.getSender().tell(new Update(70,"Googling Geostationary Geography..."), this.getSelf());
			Thread.sleep(250);

			DatazoneWindspeed windspeed = DatazoneWindspeed.getDatazoneWindspeedFromDatazone(postcodeObj.datazone);
			this.getSender().tell(new Update(80,"Eating Biscuits..."), this.getSelf());
			...
			this.getSender().tell(new Update(90,"TEA..."), this.getSelf());
			Thread.sleep(1000);
			boolean viewSolar = data.asFormUrlEncoded().get("solar") != null;
			boolean viewWind = data.asFormUrlEncoded().get("wind")  != null;
			this.getSender().tell(new Update(100,"Making Up Results..."), this.getSelf());
